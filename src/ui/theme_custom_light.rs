...
live_design! {
    ...
    pub THEME_COLOR_VAL = #3B82F6FF
    pub THEME_COLOR_VAL_HOVER = #2563DBFF
    pub THEME_COLOR_VAL_FOCUS = #1D4DD8FF
    pub THEME_COLOR_VAL_1 = #FFEDD5FF
    pub THEME_COLOR_VAL_2 = #E0E7FFFF
