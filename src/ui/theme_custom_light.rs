...
live_design! {
    ...
    pub THEME_COLOR_LABEL_INNER = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_INNER_DOWN = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_INNER_DRAG = (THEME_COLOR_LABEL_INNER_DOWN)
    pub THEME_COLOR_LABEL_INNER_HOVER = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_INNER_FOCUS = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_INNER_ACTIVE = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_INNER_INACTIVE = (THEME_COLOR_TEXT_META)
    pub THEME_COLOR_LABEL_INNER_DISABLED = (THEME_COLOR_TEXT_DISABLED)

    pub THEME_COLOR_LABEL_OUTER = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_OUTER_OFF = (THEME_COLOR_TEXT_META)
    pub THEME_COLOR_LABEL_OUTER_DOWN = (THEME_COLOR_LABEL_OUTER)

    pub THEME_COLOR_LABEL_OUTER_DRAG = (THEME_COLOR_LABEL_OUTER)
    pub THEME_COLOR_LABEL_OUTER_HOVER = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_OUTER_FOCUS = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_OUTER_ACTIVE = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_OUTER_ACTIVE_FOCUS = (THEME_COLOR_TEXT)
    pub THEME_COLOR_LABEL_OUTER_DISABLED = (THEME_COLOR_TEXT_DISABLED)
    ...
    // Primary brand color (blue) - used for buttons, links, active states
    pub THEME_COLOR_PRIMARY = (THEME_COLOR_OPAQUE_U_2)
    pub THEME_COLOR_PRIMARY_HOVER = (THEME_COLOR_OPAQUE_U_3)
    pub THEME_COLOR_PRIMARY_FOCUS = (THEME_COLOR_OPAQUE_U_3)
    pub THEME_COLOR_PRIMARY_DRAG = (THEME_COLOR_OPAQUE_U_3)
    pub THEME_COLOR_PRIMARY_DISABLED = (THEME_COLOR_OPAQUE_U_2)

    // Primary light - used for subtle backgrounds, hover states
    pub THEME_COLOR_PRIMARY_LIGHT = (THEME_COLOR_OPAQUE_U_1)
    pub THEME_COLOR_PRIMARY_LIGHT_HOVER = (THEME_COLOR_OPAQUE_U_2)
    pub THEME_COLOR_PRIMARY_LIGHT_FOCUS = (THEME_COLOR_OPAQUE_U_2)
    pub THEME_COLOR_PRIMARY_LIGHT_DRAG = (THEME_COLOR_OPAQUE_U_2)
    pub THEME_COLOR_PRIMARY_LIGHT_DISABLED = (THEME_COLOR_OPAQUE_U_1)

    // Primary lighter - used for very light backgrounds
    pub THEME_COLOR_PRIMARY_LIGHTER = (THEME_COLOR_OPAQUE_U_2)
    pub THEME_COLOR_PRIMARY_LIGHTER_HOVER = (THEME_COLOR_OPAQUE_U_3)
    pub THEME_COLOR_PRIMARY_LIGHTER_FOCUS = (THEME_COLOR_OPAQUE_U_3)
    pub THEME_COLOR_PRIMARY_LIGHTER_DRAG = (THEME_COLOR_OPAQUE_U_3)
    pub THEME_COLOR_PRIMARY_LIGHTER_DISABLED = (THEME_COLOR_OPAQUE_U_2)
    ...
    // App palette overrides for better contrast
    pub THEME_COLOR_BG_APP = #F8FAFCFF
    pub THEME_COLOR_WHITE = #FFFFFFFF
    ...
    pub THEME_COLOR_TEXT_DISABLED = #94A3B8FF
    pub THEME_COLOR_TEXT_PLACEHOLDER = #94A3B8FF
    pub THEME_COLOR_TEXT_PLACEHOLDER_HOVER = #64748BFF
    pub THEME_COLOR_TEXT_HOVER = #0F172AFF
    pub THEME_COLOR_TEXT_FOCUS = #0F172AFF
    pub THEME_COLOR_TEXT_DOWN = #0F172AFF
    pub THEME_COLOR_TEXT_CURSOR = #0F172AFF
    pub THEME_COLOR_D_3 = #334155FF

    pub THEME_COLOR_U_4 = #E0E7FFFF
    pub THEME_COLOR_U_5 = #EEF2FFFF
    pub THEME_COLOR_U_6 = #C7D2FEFF

    // Brand primary colors - Blue
    pub THEME_COLOR_PRIMARY = #3B82F6FF
    pub THEME_COLOR_PRIMARY_HOVER = #2563DBFF
    pub THEME_COLOR_PRIMARY_FOCUS = #1D4DD8FF
    pub THEME_COLOR_PRIMARY_LIGHT = #FFEDD5FF
    pub THEME_COLOR_PRIMARY_LIGHTER = #E0E7FFFF

    pub THEME_COLOR_SELECTION = #DBEAFEFF
    pub THEME_COLOR_SELECTION_HOVER = #FEE2E2FF
    pub THEME_COLOR_WARNING = #C2410CFF
    pub THEME_COLOR_ERROR = #DC2626FF
